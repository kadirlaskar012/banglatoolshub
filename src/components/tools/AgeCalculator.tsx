  ...
  return (
    <div className="flex flex-col items-center space-y-6">
        <div className='flex flex-col items-center space-y-2'>
            <label className="text-lg font-medium">আপনার জন্মতারিখ নির্বাচন করুন</label>
             <Popover>
      ...
      <Button onClick={calculateAge} size="lg">বয়স গণনা করুন</Button>

      {age && (
        <div className="mt-6 text-center p-6 bg-primary/10 rounded-lg w-full max-w-md">
          <h3 className="text-2xl font-bold mb-4">আপনার বর্তমান বয়স</h3>
